...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="将清华大学开放中文词库转换为 rime 的词库格式 .dict.yaml")
    parser.add_argument("src", help="清华大学开放中文词库文件，一般形如 THUOCL_xx.txt")
    parser.add_argument(
        "dest",
        help="目标文件路径，注意要以 .dict.yaml 结尾，" + "如果此参数省略，则会在当前目录下生成同名的 .dict.yaml 文件。",
        nargs="?",
    )
